...
public class PublishSubscribeSample {
    ...
    private static final String TestTopic = "iot/topic";
    ...
    public static class NonBlockingPublisher implements Runnable {
        ...
        public void run() {
        	...
        	try {
        		String path = "C:\\Users\\sandeepsolanki\\Downloads\\smart-home-temp-control\\smart-home-temp-control\\";
        		String file = path + "run-1564908705348-part-r-00000";
